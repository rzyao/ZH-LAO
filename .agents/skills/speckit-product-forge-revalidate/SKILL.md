...
description: 'Phase 3: Iterative revalidation and correction cycle. Shows product spec summary, collects user feedback in chat, applies corrections via a dedicated agent, and loops until explicit user approval. All revision history recorded in review.md. Use with: "revalidate spec", "review product spec", "/speckit.product-forge.revalidate"'
