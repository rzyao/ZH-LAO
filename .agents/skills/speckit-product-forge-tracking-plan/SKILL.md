...
description: 'Generates an analytics tracking plan from user journeys and product-spec. Creates event taxonomy, property schemas, funnel definitions, and ready-to-paste code snippets for your analytics SDK. Links each event to a user story and success metric. Use after product-spec: "tracking plan", "/speckit.product-forge.tracking-plan"'
