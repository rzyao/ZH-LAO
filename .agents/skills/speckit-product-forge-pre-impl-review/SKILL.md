...
description: 'Phase 5C: Combined design review, architecture review, and risk assessment gate before writing any code. Loads wireframes, UX patterns, plan architecture, and codebase analysis to produce a structured review with risk register. Optional for features with <=5 tasks and no UI. Use: "pre-impl review", "review before coding", "/speckit.product-forge.pre-impl-review"'
