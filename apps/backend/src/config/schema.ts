...
export const environmentSchema = z.object({
  ...
  CONTENT_LETTER_BATCH_POLL_INTERVAL_MS: int(10).default(1_000),
  CONTENT_LETTER_BATCH_SIZE: int(1).default(50),
  CONTENT_LETTER_BATCH_CONCURRENCY: int(1).default(4),
  CONTENT_LETTER_BATCH_ACTIVE_TASK_LIMIT: int(1).default(100),
  CONTENT_LETTER_BATCH_RETRY_AFTER_SECONDS: int(1).default(5),
