...
export const ADMIN_ROUTE_TARGETS: readonly RouteTarget[] = [
  ...
  { key: 'content.zh.pinyin', href: '/content/zh/pinyin', label: '中文拼音管理', domain: 'content' },
  { key: 'content.zh.syllables', href: '/content/zh/syllables', label: '中文音节管理', domain: 'content' },
  { key: 'content.zh.hanzi', href: '/content/zh/hanzi', label: '汉字管理', domain: 'content' },
  { key: 'content.zh.words', href: '/content/zh/words', label: '中文词语管理', domain: 'content' },
  { key: 'content.zh.sentences', href: '/content/zh/sentences', label: '中文句子管理', domain: 'content' },
  { key: 'content.zh.review', href: '/content/zh/review', label: '中文审核发布', domain: 'content' },
  { key: 'content.lo.letters', href: '/content/lo/letters', label: '老挝语字母管理', domain: 'content' },
  { key: 'content.lo.syllables', href: '/content/lo/syllables', label: '老挝语音节管理', domain: 'content' },
  { key: 'content.lo.words', href: '/content/lo/words', label: '老挝语词语管理', domain: 'content' },
  { key: 'content.lo.sentences', href: '/content/lo/sentences', label: '老挝语句子管理', domain: 'content' },
  { key: 'content.lo.review', href: '/content/lo/review', label: '老挝语审核发布', domain: 'content' },
