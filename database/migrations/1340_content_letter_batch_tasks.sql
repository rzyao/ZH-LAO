-- D-167 / ADR-028: durable Content-owned Lao-letter batch work.
-- Operator, Content, and Revision UUIDs are logical references; the only
-- physical foreign key is the item-to-task relationship inside Content.
