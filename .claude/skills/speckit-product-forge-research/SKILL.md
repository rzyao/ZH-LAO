...
description: 'Phase 1: Adaptive multi-dimensional feature research. Assesses input richness and auto-adjusts interview depth — minimal input triggers full 7-question interview, rich input skips to confirmation. Mandatory: competitors, UX/UI, codebase. Optional: tech stack, metrics/ROI. Saves to features/<name>/research/. Use with: "research feature", "/speckit.product-forge.research"'
...
`.product-forge/lessons.md` (see [`.specify/extensions/product-forge/docs/lessons-format.md`](../docs/lessons-format.md)).
