...
description: 'Generates OpenAPI 3.1 spec and Postman collection from plan.md API contracts. Auto-detects existing API framework (NestJS, Express, FastAPI, etc.), validates consistency between spec and implementation, and outputs ready-to-publish docs. Use after implement: "generate API docs", "/speckit.product-forge.api-docs"'
