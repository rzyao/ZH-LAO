...
description: 'Phase 0: Validates the problem before any research begins. Runs JTBD analysis, generates an interview script, builds a Problem Statement Canvas, and outputs a scored confidence report. Prevents investing in features that solve the wrong problem. Use before research: "discover the problem", "/speckit.product-forge.problem-discovery"'
