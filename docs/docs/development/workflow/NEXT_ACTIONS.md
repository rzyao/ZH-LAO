...
首先读取 workflow/index.md、AI_STAGE_MODEL.md、TASK_MANIFEST_SCHEMA.md 与 workflow/tasks/CONTENT-BACKEND-PREP.yaml。
...
首先读取 workflow/index.md、AI_STAGE_MODEL.md 与 workflow/tasks/PLATFORM-ADMIN-STAGE-B.yaml。
...
首先读取 workflow/index.md、AI_STAGE_MODEL.md 与 workflow/tasks/LOGIN-MOBILE-DESIGN.yaml。
...
首先读取 workflow/index.md、AI_STAGE_MODEL.md 与 workflow/tasks/OPERATIONS-ADMIN-DESIGN.yaml。
...
首先读取 workflow/index.md、AI_STAGE_MODEL.md 与 workflow/tasks/AUDIO-PRODUCTION-ADMIN-DESIGN.yaml。
