...
```text
docs/docs/development/v2/workflow/tasks/<TASK_ID>.yaml
```
...
brief:
  path: docs/docs/development/v2/05-content/CONTENT_EXECUTION_BRIEF.md
...
allowed_paths:
  - apps/backend/**
  - docs/docs/development/v2/05-content/**
  - docs/docs/development/v2/workflow/tasks/CONTENT-BACKEND.yaml
  - docs/docs/development/v2/workflow/events/**
  - docs/docs/development/v2/workflow/claims/CONTENT-BACKEND.md
...
required_sources:
  ...
  - docs/docs/development/v2/04-operations/OPERATIONS_PUBLIC_CONTRACTS.md
...
final_report:
  path: docs/docs/development/v2/05-content/CONTENT_IMPLEMENTATION_REPORT.md
```
...
dependency_snapshot:
  ...
  - path: docs/docs/development/v2/05-content/CONTENT_PUBLIC_CONTRACTS.md
    sha: def456
```
