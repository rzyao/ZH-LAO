...
首先依次读取：
1. `docs/docs/development/v2/workflow/index.md`
2. `docs/docs/development/v2/workflow/ROLE_MODEL.md`
3. `docs/docs/development/v2/workflow/SESSION_HANDOFF_CONTRACT.md`
4. `docs/docs/development/v2/workflow/CONCURRENCY_RULES.md`
5. `docs/docs/development/v2/workflow/tasks/<TASK_ID>.yaml`
