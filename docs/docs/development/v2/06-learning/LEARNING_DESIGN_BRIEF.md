...
```text
docs/docs/development/v2/05-content/CONTENT_PRODUCT_SEMANTICS.md
docs/docs/development/v2/05-content/CONTENT_USE_CASES.md
docs/docs/development/v2/05-content/CONTENT_PUBLIC_CONTRACTS.md
docs/docs/development/v2/05-content/CONTENT_API.md
docs/docs/development/v2/05-content/CONTENT_IMPLEMENTATION_REPORT.md if present
...
```text
docs/docs/development/v2/06-learning/LEARNING_PRODUCT_SEMANTICS.md
docs/docs/development/v2/06-learning/LEARNING_USE_CASES.md
docs/docs/development/v2/06-learning/LEARNING_PROGRESS_CONTRACTS.md
docs/docs/development/v2/06-learning/LEARNING_API.md
docs/docs/development/v2/06-learning/LEARNING_PUBLIC_CONTRACTS.md
docs/docs/development/v2/06-learning/LEARNING_IMPLEMENTATION_PLAN.md
docs/docs/development/v2/06-learning/LEARNING_DESIGN_AUDIT.md
```
