...
```text
docs/docs/development/04-operations/OPERATIONS_IMPLEMENTATION_PLAN.md
docs/docs/development/04-operations/OPERATIONS_USE_CASES.md
docs/docs/development/04-operations/OPERATIONS_RBAC_CONTRACTS.md
docs/docs/development/04-operations/OPERATIONS_API.md
docs/docs/development/04-operations/OPERATIONS_DESIGN_AUDIT.md
```
