...
| 功能 | 主要用户 | 核心领域 | Backend | Admin | Mobile | 功能验收 |
| --- | --- | --- | --- | --- | --- | --- |
| [登录与会话](login/index.md) | App 用户 | Identity | 已有后端实现与 Gate 证据 | 不适用 | 真实 Identity 集成待完成 | 待完成 |
| [音频生产](audio-production/index.md) | 运营人员 | Audio Production | 设计完成，正式实现待推进 | 音频生产工作台待实施 | 非生产主入口 | 待完成 |
...
规范见 [功能文档规范](FEATURE_DOCUMENT_STANDARD.md)。
