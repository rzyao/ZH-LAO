...
本能力定义为 **首个管理员 Bootstrap**（`first-admin-bootstrap`）。本页保留该能力的现有描述；如果现有资料没有明确用户价值，本页不自行补造。
...
- [docs/docs/developer/reference/domains/operations/audit.md](/developer/reference/domains/operations/audit)
