...
本能力定义为 **用户首页与双侧入口**（`mobile-home`）。本页保留该能力的现有描述；如果现有资料没有明确用户价值，本页不自行补造。
...
- 声明的 Domain：`content`, `learning`, `social`, `platform`
...
`mobile-home` 是当前正式 Feature 清单中的功能。Feature Inventory 记录其参与领域为 [Content](/developer/reference/domains/content/index.md)、[Learning](/developer/reference/domains/learning/index.md)、[Social](/developer/reference/domains/social/index.md)、[Platform](/developer/reference/domains/platform/index.md)，交付 surface 为 Mobile、集成与验收；当前各实施 实际 Stage / Gate 尚未启动。
