...
- /developer/reference/contracts/learning/LEARNING_USE_CASES
- /developer/reference/contracts/learning/LEARNING_API
---
...
本能力定义为 **即时中老翻译**（`instant-translation`）。本页保留该能力的现有描述；如果现有资料没有明确用户价值，本页不自行补造。
...
- [/developer/reference/contracts/learning/LEARNING_USE_CASES](/developer/reference/contracts/learning/LEARNING_USE_CASES)
- [/developer/reference/contracts/learning/LEARNING_API](/developer/reference/contracts/learning/LEARNING_API)
