...
当前正式领域边界见 [领域边界](/developer/reference/domains/)，跨领域协作见 [领域依赖与协作](/developer/reference/architecture/domains/dependencies.md)。数据库原则的关键历史决策见 [ADR-018](/developer/reference/adr/ADR-018-global-database-design-principles-final.md)。
