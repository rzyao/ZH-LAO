...
**相关：** [Operations 域](/developer/reference/domains/operations/index.md)、[Operations 数据库](/developer/reference/domains/operations/database.md)、[Domain Map](/developer/reference/architecture/domain-map.md)、[ADR-015](ADR-015-chat-naming-and-sql-adjudication.md)、[ADR-018](ADR-018-global-database-design-principles-final.md)
