...
- 文档维护阶段不自行推翻上述裁决；后续若需新增 Group / Voice / Translation，通过新增表或枚举值扩展，不推翻七表核心模型（见 [ADR-011~014](/developer/reference/adr/ADR-011-chat-conversation-identity-and-direct-uniqueness.md) 与 [Chat 数据库](/developer/reference/domains/chat/database.md)）。

## 事实源

- [Chat 数据库总览](/developer/reference/domains/chat/database.md)「与全局 SQL 规范的关系」
- [Chat 域 · 命名裁决](/developer/reference/domains/chat/index.md)
- [设计台账 D-055 / D-057](/developer/reference/governance/design-register.md)
