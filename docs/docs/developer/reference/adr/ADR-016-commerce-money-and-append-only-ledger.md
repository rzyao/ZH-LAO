...
- [Commerce 域](/developer/reference/domains/commerce/index.md)
- [Commerce 数据库 · Schema V1](/developer/reference/domains/commerce/database.md)「与全局 SQL 规范的关系」
- [PostgreSQL 总规范](/developer/reference/architecture/database.md)
