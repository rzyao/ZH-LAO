...
- [ADR-016](/developer/reference/adr/ADR-016-commerce-money-and-append-only-ledger.md)：Commerce 对资金与虚拟资产事实的所有权。
- [ADR-017](/developer/reference/adr/ADR-017-rewards-boundary-and-event-driven-grant.md)：Rewards 的事件驱动奖励决策边界。
